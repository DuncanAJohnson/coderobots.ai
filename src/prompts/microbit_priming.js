...
\`\`\`python # Importerer modulet til at styre displayet \`\`\` Make sure that the code is thoroughly commented.
...
Prompt: "Vis et hjerte på displayet"

Code:
\`\`\`python
from microbit import *

# Viser et hjerte-ikon på LED-displayet
display.show(Image.HEART)
\`\`\`

--------------------------------

Prompt: "Lav en terning der viser et tilfældigt tal når man ryster micro:bitten"
...
# Kør for evigt
while True:
    # Tjek om micro:bitten bliver rystet
    if accelerometer.was_gesture('shake'):
        # Vælg et tilfældigt tal mellem 1 og 6
        tal = random.randint(1, 6)
        # Vis tallet på displayet
        display.show(tal)
    # Kort pause for at spare strøm
    sleep(100)
\`\`\`

--------------------------------

Prompt: "Skriv kode der tænder en LED på pin0 når knap A trykkes og slukker den når knap B trykkes"
...
# Kør for evigt
while True:
    # Hvis knap A er trykket, tænd LED på pin0
    if button_a.is_pressed():
        pin0.write_digital(1)
    # Hvis knap B er trykket, sluk LED på pin0
...
# Tænd radioen og sæt gruppe til 1
radio.on()
radio.config(group=1)

while True:
    # Send besked når knap A trykkes
    if button_a.was_pressed():
        radio.send('hej')
        display.scroll('Sendt!')

    # Tjek om der er modtaget en besked
...
Prompt: "Spil en melodi på micro:bitten"
...
# Spil den indbyggede fødselsdagsmelodi
music.play(music.BIRTHDAY)

# Vis et glad ansigt når melodien er færdig
